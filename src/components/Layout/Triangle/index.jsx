...
{(showTriangle || screenWidth > 870) && (<> <div onClick={hideTriangle} className={styles.triangle}>
        <a
      ...
      {screenWidth < 870 && <img className={styles.hideTriangleArrow} onClick={hideTriangle}  src="src/assets/icons8-double-up-24.png" alt="" />}
 </>)}
     {(!showTriangle && screenWidth < 870) && <><div
      onClick={() => setShowTriangle(true)} className={styles.arrowTriangle}>
        <img src="src/assets/icons8-double-up-24.png" alt="" />
        <span>CV & GH</span></div><div className={styles.arrowTriangleBorder} ></div></>}
    </>
  );
}
